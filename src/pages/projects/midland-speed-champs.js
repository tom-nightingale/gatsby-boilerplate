...
const ProjectsPage = (props) => {
    ...
    const project = {
        ...
        bgColor: '#000',
        coverImage: "leagueBg",
        services: "Web Design & Development, Custom development",
        url: "http://www.speedchampionship.org.uk/",
    }
    ...
    return (
        ...
        <>
            ...
            <PageHeader
                img={props.data.midlandSpeedChamps.childImageSharp.fluid}
            ...
            <div className="container max-w-full w-full md:p-16 md:flex flex-wrap md:px-0">
                ...
                <BackgroundImage className="latest-project w-full" fluid={props.data.midlandSpeedChamps.childImageSharp.fluid}>
                </BackgroundImage>
            ...
            <div className="w-full mx-auto flex flex-wrap items-center justify-center">
                <div className="w-full md:w-2/6 lg:w-1/3 p-4 md: p-8">
                    <BackgroundImage
                        fluid={props.data.midlandSpeedChamps.childImageSharp.fluid}
