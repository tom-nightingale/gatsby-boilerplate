...
const ImageCard = (props) => {
    return (
        ...
        >
            ...
            <Link to="/" className="absolute translate-y-full group-hover:translate-y-0 transition-all transition-250 flex flex-col justify-center w-full h-full p-16 lg:px-24 xl:px-32 lg:py-40 bg-navy-500 opacity-95">
